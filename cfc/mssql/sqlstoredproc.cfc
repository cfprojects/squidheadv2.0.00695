...
<cfcomponent extends="squidhead2.cfc.base.SQLStoredProc">
	...
	<cffunction access="public" name="createProcedureList" output="false" returntype="struct" description="Creates a stored proc for a table list.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Lists all records in table #variables.tableName#")) />
	...
	<cffunction access="public" name="createProcedureSelect" output="false" returntype="struct" description="Creates a stored proc for a table select.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Selects one record in table #variables.tableName#")) />
	...
	<cffunction access="public" name="createProcedureDelete" output="false" returntype="struct" description="Creates a stored proc for a table delete.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Deletes one record in table #variables.tableName#")) />
	...
	<cffunction access="public" name="createProcedureUpdate" output="false" returntype="struct" description="Creates a stored proc for a table update.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Updates one record in table #variables.tableName#")) />
	...
	<cffunction access="public" name="createProcedureInsert" output="false" returntype="struct" description="Creates a stored proc for a table insert.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Inserts one record into table #variables.tableName#")) />
	...
	<cffunction access="public" name="createProcedureSearch" output="false" returntype="struct" description="Creates a stored proc for a table update.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Performs various searches on table:  #variables.tableName#")) />
	...
	<cffunction access="public" name="createListThroughJoinTable" output="false" returntype="struct" description="Creates a stored proc for a table list.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Lists all records in table #variables.tableName# that are linked to record in #arguments.otherTable# through table #joinTable# ")) />
	...
	<cffunction access="public" name="createProcedureListByForeignKey" output="false" returntype="struct" description="Creates a stored proc for a table list by a foreign key. ">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Lists all records in table #variables.tableName# by #arguments.foreignKey#")) />
	...
	<cffunction access="public" name="createProcedureListwithForeignKeys" output="false" returntype="struct" description="Creates a stored proc for a table list.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Lists all records in table #variables.tableName# with columns replaced by their foreign key.")) />
	...
	<cffunction access="public" name="createProcedureSelectwithForeignKeys" output="false" returntype="struct" description="Creates a stored proc for a table list.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Selects one record in table #variables.tableName# with columns replaced by their foreign key.")) />
	...
	<cffunction access="public" name="createProcedureListForeignKeyLabels" output="false" returntype="struct" description="Creates a stored proc for a table list.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Lists the id and foriegn key label for table: #variables.tableName#")) />
	...
	<cffunction access="public" name="createProcedureJoinTableUnique" output="false" returntype="struct" description="Creates a stored proc for a table to read in unique join table records.">
		...
		<cfset procContents.append(createComment(name=procName, author="Squidhead", description="Reads one record in table #variables.tableName# by its join columns")) />
