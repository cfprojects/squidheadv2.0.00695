...
<cfcomponent output="FALSE">
	...
	<cffunction access="public" name="init" output="true" returntype="any" description="Psuedo Constructor and all around nice function." >
		...
		<cfargument name="version" type="string" required="yes"  hint="The current version of Squidhead." />
		...
		<cfset config['settings']['squidheadVersion'] = arguments.version />
			...
			<cftry>
				...
				<cfcatch type="any">
					<cfif FindNoCase("is undefined in a CFML structure referenced as part of an expression", cfcatch.Message)>
						<cfthrow type="application" message="Requested setting does not exists in this configuration. Check your Squidhead configuration file for the correct setting."
