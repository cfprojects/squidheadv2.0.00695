...
<dl>
	...
	<dl>
		...
		<dd>If you do a pass through join through a table named tablenameToOtherTableName, Squidhead will create a stored proc that will join through the middle table.</dd>
	</dl>
