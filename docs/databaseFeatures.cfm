...
<h2>Effects of various database features on Squidhead</h2>
...
<div class="captionedimage" style="width:300px;">
	...
	<p class="caption"><strong>Figure 4.</strong> Example of many to many relationship as setup for use in Squidhead.</p>
</div>
