	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/tools/riaforge/index.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/steps/cfc_dao_gateway.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/settings.properties (A)</li>
		
			
			
		
	
		<li>/squidhead/build.xml (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/customtag.cfc (M)</li>
		
			
			
		
	
		<li>/squidhead/cfc/base/sqlstoredproc.cfc (M)</li>
		
	
		<li>/squidhead/cfc/mssql/sqlstoredprocactive.cfc (M)</li>
		
	
		<li>/squidhead/cfc/mssql/sqlstoredproc.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/steps/cfc_business_dynamic.cfm (M)</li>
		
			
			
		
	
		<li>/squidhead/templates/baseCFCs/fkCrazy/baseBusiness.cfc (M)</li>
		
	
		<li>/squidhead/templates/baseCFCs/fkCrazy/baseDAO.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/steps/cfc_business.cfm (M)</li>
		
			
			
		
	
		<li>/trunk/squidhead/templates/cfmltemplates/default/objectTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/steps/cfunit.cfm (M)</li>
		
	
		<li>/trunk/squidhead/steps/cfc_business_dynamic.cfm (M)</li>
		
	
		<li>/trunk/squidhead/templates/cfmltemplates/fkCrazy/objectTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/templates/cfmltemplates/simple/objectTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/steps/cfc_dao_gateway.cfm (M)</li>
...
Helps with issues like tables being named with over zealous hungarian notation. </st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/templates/customtagtemplates/simple/listTemplate.cfm (M)</li>
		
			
			
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/simple/readTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/cfc/mssql/database.cfc (M)</li>
		
	
		<li>/trunk/squidhead/steps/cfms.cfm (M)</li>
		
	
		<li>/trunk/squidhead/steps/customtags.cfm (M)</li>
		
	
		<li>/trunk/squidhead/cfc/oracle/database.cfc (M)</li>
		
	
		<li>/trunk/squidhead/cfc/mysql/database.cfc (M)</li>
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/fkCrazy/formTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/steps/cfc_dao_gateway.cfm (M)</li>
		
	
		<li>/trunk/squidhead/cfc/base/database.cfc (M)</li>
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/fkCrazy/readTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/fkCrazy/listTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/steps/cfc_business.cfm (M)</li>
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/default/formTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/simple/formTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/default/listTemplate.cfm (M)</li>
		
	
		<li>/trunk/squidhead/templates/customtagtemplates/default/readTemplate.cfm (M)</li>
	...
	<dl>
	<dt>Made a number of changes to make squidhead example apps work on my new system. </st>

	<dd>
	<p style="font-size: .9em;">Files Effected</p>
	<ul style="font-size: .8em;">
	
		<li>/trunk/squidhead/settings.properties (M)</li>
		
			
			
		
	
		<li>/trunk/squidhead/config/blogmac.cfm (M)</li>
		
	
		<li>/trunk/squidhead/build.xml (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/cfc/mssql/sqlstoredprocactive.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/tools/Application.cfc (A)</li>
		
	
		<li>/trunk/squidhead/tools/application.cfc (D)</li>
		
	
		<li>/trunk/squidhead/Application.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/tools/refresh/index.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/tools/cfcDoc/index.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/tools/releasenotesBuilder/publishToRiaForge.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/tools/documentationBuilder/index.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/trunk/squidhead/tools/releasenotesBuilder/pulldownfromRIAForge.cfm (M)</li>
...
Helps with issues like tables being named with over zealous hungarian notation. </st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/tools/refresh/index.cfm (M)</li>
		
		<li>/squidhead/cfc/base/database.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/templates/cfmltemplates/simple/objectTemplate.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/templates/cfmltemplates/fkCrazy/objectTemplate.cfm (M)</li>
		
		<li>/squidhead/templates/customtagtemplates/fkCrazy/formTemplate.cfm (M)</li>
	...
	<dl>
	<dt>Fixed Bug 25 : http://squidhead.riaforge.org/index.cfm?event=page.issueedit&issueid=63B7DB81-F255-09CA-8F1035ED2FBECDFF.
...
Select arguments were not being qualified with brackets in certain MSSQL stored procs. </st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/error_exception.cfm (M)</li>
		
		<li>/squidhead/docs/installation.cfm (A)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/docs/index.cfm (M)</li>
		
		<li>/squidhead/docs (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/mysql/sqlstoredproc.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/base/constants.cfc (M)</li>
	...
	<dl>
	<dt>Fixed issue with multiple output variables in MSSQL.  Basically Squidhead correctly put more than output variable into a structure, but didn't change the function output type to structure.</st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/oracle/database.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/tools/cfcDoc/index.cfm (M)</li>
	...
	<dl>
	<dt>Fixed a series of bugs preventing Squidhead from running in Linux. Mostly related to casing of components. </st>

	<dd>
	<p style="font-size: .9em;">Files Effected</p>
	<ul style="font-size: .8em;">
	
		<li>/squidhead/cfc/oracle/sqlstoredprocactive.cfc (A)</li>
		
		<li>/squidhead/cfc/oracle/SQLStoredProcActive.cfc (D)</li>
		
		<li>/squidhead/cfc/oracle/foreignKey.cfc (D)</li>
		
		<li>/squidhead/cfc/mysql/foreignkey.cfc (A)</li>
		
		<li>/squidhead/Application.cfc (M)</li>
		
		<li>/squidhead/cfc/oracle/SQLStoredProc.cfc (D)</li>
		
		<li>/squidhead/cfc/mysql/sqlstoredproc.cfc (A)</li>
		
		<li>/squidhead/cfc/base/SQLStoredProcActive.cfc (D)</li>
		
		<li>/squidhead/cfc/base/sqlstoredprocactive.cfc (A)</li>
		
		<li>/squidhead/cfc/base/SQLStoredProc.cfc (D)</li>
		
		<li>/squidhead/cfc/functionhelper.cfc (A)</li>
		
		<li>/squidhead/cfc/stepTracker.cfc (D)</li>
		
		<li>/squidhead/cfc/antBuilder.cfc (D)</li>
		
		<li>/squidhead/cfc/cfstoredproc.cfc (A)</li>
		
		<li>/squidhead/cfc/mssql/SQLStoredProcActive.cfc (D)</li>
		
		<li>/squidhead/cfc/mssql/sqlstoredprocactive.cfc (A)</li>
		
		<li>/squidhead/cfc/mssql/foreignKey.cfc (D)</li>
		
		<li>/squidhead/cfc/mssql/SQLStoredProc.cfc (D)</li>
		
		<li>/squidhead/cfc/mysql/SQLStoredProcActive.cfc (D)</li>
		
		<li>/squidhead/cfc/mysql/sqlstoredprocactive.cfc (A)</li>
		
		<li>/squidhead/cfc/mysql/foreignKey.cfc (D)</li>
		
		<li>/squidhead/cfc/oracle/foreignkey.cfc (A)</li>
		
		<li>/squidhead/cfc/mysql/SQLStoredProc.cfc (D)</li>
		
		<li>/squidhead/cfc/oracle/sqlstoredproc.cfc (A)</li>
		
		<li>/squidhead/cfc/base/sqlstoredproc.cfc (A)</li>
		
		<li>/squidhead/cfc/functionHelper.cfc (D)</li>
		
		<li>/squidhead/cfc/steptracker.cfc (A)</li>
		
		<li>/squidhead/cfc/antbuilder.cfc (A)</li>
		
		<li>/squidhead/cfc/CFstoredProc.cfc (D)</li>
		
		<li>/squidhead/cfc/mysql/help.cfc (M)</li>
		
		<li>/squidhead/cfc/mssql/foreignkey.cfc (A)</li>
		
		<li>/squidhead/cfc/mssql/sqlstoredproc.cfc (A)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/steps/cfms.cfm (M)</li>
		
		<li>/squidhead/config/facebook_linux.cfm (A)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/mysql/sqlstoredprocactive.cfc (M)</li>
		
		<li>/squidhead/cfc/mysql/database.cfc (M)</li>
	...
	<dl>
	<dt>Added configuration "settings" "IgnoreXMLCache".  This feature tells squidhead to stop looking at the XML cache. It speeds up table analysis at the cost of the features of the XML cache.  If you don't know what they are, then you can safely set this to true. 
...
Hopefully someday I can improve the performance of the XML cache, rendering this feature obsolete.</st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/config/cigar.cfm (M)</li>
		
		<li>/squidhead/cfc/base/database.cfc (M)</li>
		
		<li>/squidhead/config/defaultPreLoad.cfm (M)</li>
	...
	<dl>
	<dt>Fixing bug which caused Squidhead to truncate decimal values.  </st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/cfstoredproc.cfc (M)</li>
		
		<li>/squidhead/cfc/oracle/help.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/steps/cfunit.cfm (M)</li>
...
Thanks Nathan, that's very elegant.</st>
	...
	<dl>
	<dt>Made a change that prevented Squidhead from creating lists of linking tables in the business object of a table linked by a linking table.  Why? Well since those linking tables don't really store information in their own right, why include them.  </st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/oracle/database.cfc (A)</li>
		
		<li>/squidhead/cfc/oracle (A)</li>
		
		<li>/squidhead/cfc/oracle/table.cfc (A)</li>
		
		<li>/squidhead/cfc/oracle/help.cfc (A)</li>
		
		<li>/squidhead/cfc/oracle/constants.cfc (A)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/config/blog_oracle.cfm (A)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/oracle/SQLStoredProc.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/oracle/package.cfc (A)</li>
	...
	<dl>
	<dt>Oracle components pass all unit tests.  Squidhead now officially supports Oracle. Queue bug reports in 3....2...1....</st>

	<dd>
	<p style="font-size: .9em;">Files Effected</p>
	<ul style="font-size: .8em;">
	
		<li>/squidhead/cfc/oracle/SQLStoredProcActive.cfc (M)</li>
		
		<li>/squidhead/steps/cfunit.cfm (M)</li>
		
		<li>/squidhead/templates/customtagtemplates/default/formTemplate.cfm (M)</li>
		
		<li>/squidhead/cfc/oracle/SQLStoredProc.cfc (M)</li>
		
		<li>/squidhead/templates/customtagtemplates/fkCrazy/formTemplate.cfm (M)</li>
		
		<li>/squidhead/config/blog_oracle.cfm (M)</li>
		...
		<li>/squidhead/cfc/oracle/package.cfc (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/cfc/function.cfc (M)</li>
		
		<li>/squidhead/templates/cfmltemplates/fkCrazy/applicationTemplate.cfm (M)</li>
		
		<li>/squidhead/templates/cfmltemplates/simple/applicationTemplate.cfm (M)</li>
		
		<li>/squidhead/templates/cfmltemplates/simple/objectTemplate.cfm (M)</li>
		
		<li>/squidhead/templates/customtagtemplates/simple/formTemplate.cfm (M)</li>
		
		<li>/squidhead/steps/cfc_dao_gateway.cfm (M)</li>
		
		<li>/squidhead/templates/cfmltemplates/default/applicationTemplate.cfm (M)</li>
	...
	<dl>
	<dt>Added coldspringGenerateConfig step. Squidhead now generates Coldspring config files.</st>

	<dd>
	<p style="font-size: .9em;">Files Effected</p>
	<ul style="font-size: .8em;">
	
		<li>/squidhead/steps/buildDirectories.cfm (M)</li>
		
		<li>/squidhead/config/blog_mysql.cfm (M)</li>
		
		<li>/squidhead/config/defaultPostLoad.cfm (M)</li>
		
		<li>/squidhead/steps/coldspringGenerateConfig.cfm (A)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/config/wrdscommunity.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/templates/baseCFCs/default/baseBusiness.cfc (M)</li>
...
This results in about a 25% reduction in run time for a moderately complex table. More if you have a lot of foreign keys, less if you don't. </st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/steps/customtags.cfm (M)</li>
		
		<li>/squidhead/config/wrdscommunity.cfm (M)</li>
		
		<li>/squidhead/cfc/base/database.cfc (M)</li>
		
		<li>/squidhead/steps/sqlWriteStoredProcs.cfm (M)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/templates/basecustomtags/foreignKeySelector.cfm (M)</li>
	...
	<dl>
	<dt>Added documentation on how Squidhead reacts to certain database features including foreign keys and unique constraints.</st>

	<dd>
	<p style="font-size: .9em;">Files Effected</p>
	<ul style="font-size: .8em;">
	
		<li>/squidhead/docs/img/oneToMany.jpg (A)</li>
		
		<li>/squidhead/build.xml (M)</li>
		
		<li>/squidhead/docs/databaseFeatures.cfm (A)</li>
		
		<li>/squidhead/docs/img/manyToMany.jpg (A)</li>
		
		<li>/squidhead (M)</li>
		
		<li>/squidhead/docs/img/dropDowns.jpg (A)</li>
		
		<li>/squidhead/docs/img/uniqueContstraint.jpg (A)</li>
		
		<li>/squidhead/docs/img (A)</li>
		
		<li>/squidhead/tools/releasenotesBuilder/getHistory.cfm (A)</li>
		
		<li>/squidhead/customtags/navDoc.cfm (M)</li>
		
		<li>/squidhead/docs/img/foriegnkeys.jpg (A)</li>
...
Should be last step to one step build. </st>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/tools/releasenotesBuilder/pulldownfromRIAForge.cfm (A)</li>
		
		<li>/squidhead/tools/releasenotesBuilder/index.cfm (M)</li>
		
		<li>/squidhead/tools/releasenotesBuilder/publishToRiaForge.cfm (A)</li>
		
		<li>/squidhead/tools/releasenotesBuilder/getHistory.cfm (D)</li>
	...
	<ul style="font-size: .8em;">
		...
		<li>/squidhead/tools/pdfgenerator/index.cfm (M)</li>
...
Should be last step to one step build. </st>
	...
	<hr />
		...
		<p>
				...
				<p>Most of the changes here have to do with Foreign Keys and the FKCrazy template. Squidhead can now detect many to many relationships across [table]To[table] assuming that their are foreign keys in the tableToTable table and they are named the same as the primary keys in joined tables. It allows you to add and delete those relationships.  If you actually read this, and this doesn't make sense drop me a line.  I'll record another video to explain it. (I really don't know how to explain it.)  If you are using the FKCrazy template, make sure you replace the baseBusiness.cfc.</p>

<p>Unique constraints are now recognized by Squidhead. If there is a unique constraint on a table, it writes a read by column procedure automatically, and can be used in business object instantiation. </p>
...
<p>Note the changes are include swapping cfc_business_dynamic in for cfc_business and chaning the application template to "fkCrazy" cause it really is fkCrazy to do this. If you are going against an already made squidhead application make sure that you do one of two things: delete your business cfc directory or change all of the inheritance so that the top level business objects inherit from their lower counterparts. </p>
...
Added more user feedback on adds and updated to the UI and custom tag layer.
	...
	<hr />
		...
		<p>
				...
				<p>By adding MySql support I attracted Mac users to give Squidhead a try. <a href="http://angry-fly.com/">Russ Johnson</a> found a number of bugs that crop on a Mac.  Most were because I missed a few "\"'s that should have been "/"'s. Plus I might have discovered a CFImage bug on CF 8 for Mac OSX.</p> 
...
<p>Thanks, Russ, for finding the bugs, and forcing me to get my Mac Mini up an running. </p>
	...
	<hr />
		...
		<p> <p>New features: </p><ul><li><strong>MySql 5.0 Support </strong></li><li>It creates Ant Build files for common tasks 
			...
			</p><ul><li>Squidhead: ColdFusion 8 </li><li>Database: Microsoft SQL 2000 or 2005; MySql 5.0 </li><li>Generated Application Using MSSQL: 
			ColdFusion 7 or 8 </li><li>Generated Application Using MySql: ColdFusion 8 </li></ul><p>Notes: </p><ul><li>For the most part, your old 
			config files will still work. However the more changes you made the more likely they are to have problems. </li></ul><p>Old versions of Squidhead still available at 
			<a href="http://www.numtopia.com/squidhead">http://www.numtopia.com/squidhead</a>.</p> </p>
	<hr />
	...
	<hr />
		...
		<p> A whole bunch of little things: Forced Squidhead application scope to refresh on everypage call. Forced Squidhead application to be unique to the file path on the server. Added better 
	...
	<hr />
		...
		<p> Added a feature: With the config flag - config['settings']['generateStoredProcedureFiles'] set to true, Squidhead will write a sql file for every stored procedure containing a drop 
	...
	<hr />
		...
		<p> Note: This will definitely require you to reset the application scope of your installation of squidhead. Call the index.cfm page of squidhead with the url variable resetApp=true. 
	...
	<hr />
		...
		<p> Couple of Minor fixes this time around. Fixed a bug where Squidhead was referring to <tablename>ID instead of the actual identity column of the table. Added settings to allow for 
			...
			the version number of Squidhead appear in the comments of a stored proc. Altered the menus on the ui framework patterns. </p>
	<hr />
	...
	<hr />
		...
		<p> Another big feature added, with some smaller updates. Squidhead now generates it's own CFUnit tests. Currently they only test the CRUD for tables with identities in the DAO's, but in 
			...
			then they will be added to Squidhead's tests the next time Squidhead is run. This feature will require <a href="http://cfunit.sourceforge.net/">CFUnit</a>. Also: Altered the 
	...
	<hr />
		...
		<p> Fixed Issue #17. Squidhead now looks to stored procedure parameters to determine if the calling function arguments that correspond to the params are required. Up until now, we were 
