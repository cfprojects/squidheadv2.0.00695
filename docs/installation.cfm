<h2>Installation</h2>
<ul>
<li>Unzip Squidhead.zip and place in web accessible location</li>
<li>Browse to Index.cfm.</li>
<li>Go to Add Application</li>
<li>Fill in relevant information and save</li>
<li>Squidhead is now ready to build your application</li>
<li>You may need to tweak your config file to get Squidhead to build the application the way you want. See <a href="config.cfm">config reference</a> for details.</li>
</ul>
...
<h3>MYSql</h3>
<p>Account used with Squidhead must have SELECT permission on the table <em>'proc'</em> in schema <em>'mysql'</em>. </p>