...
<dl>
	...
	<dd>These configurations all refer to settings for the application Squidhead will create. </dd>
	...
	<dl>
		...
		<dd>An ordered array of the steps that squidhead will perform.</dd>
	...
	<dt>config['cfc']</dt>
	<dd>These are CFC paths for squidhead CFC's which perform specialized functions. </dd>
	...
	<dd>A collection of paths where Squidhead will create certain files.</dd>
	...
	<dl>
		...
		<dd>The path in which to store all of the business files.(These aren't overwritten by Squidhead)</dd>
		...
		<dd>Path where squidhead will store dynamically generated business objects.</dd>
		...
		<dd>The top level path of all of the CFC's cretaed by Squidhead.</dd>
		...
		<dd>Path where squidhead will store dynamically generated config files currently only for ColdSpring.</dd>
		...
		<dd>The path in which to store all of the static customtag files.(These aren't overwritten by Squidhead)</dd>
		...
		<dd>The path in which to store all of the dynamic customtag files.(These are overwritten by Squidhead)</dd>
		...
		<dd>The path in which to store all of the static dao files.(These aren't overwritten by Squidhead)</dd>
		...
		<dd>The path in which to store all of the dynamic dao files.(These are overwritten by Squidhead)</dd>
		...
		<dd>The path in which to store all of the dynamic gateway files.(These are overwritten by Squidhead)</dd>
		...
		<dd>The path in which to store all of the static gateway files.(These aren't overwritten by Squidhead)</dd>
		...
		<dd>A location for storing images that Squidhead generates.</dd>
	...
	<dd>These are words and strings that when you use in the database, will have a specific effect on the way Squidhead works with it.</dd>
	...
	<dl>
		...
		<dd>Bit fields with this name will cause Squidhead to write delete and list functions that treat deleted records as deactivated (active = false). A good choice if you have a 
		...
		<dd>A datetime field with this reserved word will be automatically set by the code Squidhead creates, and only on insert operations.</dd>
		...
		<dd>Tables that start with this string will be ignore by Squidhead. </dd>
		...
		<dd>A date field with this reserved word will be automatically set by the code Squidhead creates.</dd>
	...
	<dd>These are general settings that determines how Squidhead runs.</dd>
	...
	<dl>
		...
		<dd>Whether or not to have Squidhead create SQL files for adding adding and dropping every stored procedure individually.</dd>
		...
		<dd>Setting instructs Squidhead to ignore the XMLCache when inspecting the database. Will speed up process at cost of not overiding values from the XMLCache.</dd>
